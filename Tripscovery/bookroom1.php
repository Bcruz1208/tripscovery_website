<html>
	...
	$sql2 = "SELECT * FROM temp_session";
	$sql3 = "SELECT * FROM temp_session";
	...
	$sql2 = "INSERT INTO booked_hist VALUES ('$phone', '$name', '$id', '$room', '$checkin', '$checkout', '$days', '$ac', '$breakfast', '$lunch', '$snacks', '$dinner', '$swimming', '$price', '$t')";
	$sql3 = "INSERT INTO balance VALUES ('$r[0]')";
