...
<body>
	...
	<div style="background-color: #f2f2f2;">
		<form action="user_signed_up.php" method="post">
			...
			<table>
				<tr>
					<td colspan="2"><p style="font-size: 35px; font-family: 'Times New Roman', serif; color: #009999;"><b>Create an Account</b></p></td>
				</tr>
				<tr>
					<td style="padding-left: 60px; text-align: left;">Name: </td>
					<td><input class="input" type="text" name="name" placeholder="Enter Full Name" required></td>
				</tr>
				<tr>
				...
				<tr>
					<td style="padding-left: 60px; text-align: left;">Email Address: </td>
					<td><input class="input" type="email" name="email" placeholder="Enter your Email Address" required></td>
				</tr>
				<tr>
					<td style="padding-left: 60px; text-align: left;">Email ID Proof: </td>
